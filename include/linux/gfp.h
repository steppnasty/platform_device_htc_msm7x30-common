...
#define __GFP_NOTRACK	((gfp_t)0x200000u)  /* Don't track with kmemcheck */
#else
...
static __inline__ int allocflags_to_migratetype(gfp_t gfp_flags)
{
...
static __inline__ enum zone_type gfp_zone(gfp_t flags)
{
	enum zone_type z;
...
static __inline__ int gfp_zonelist(gfp_t flags)
{
 ...
 */
static __inline__ struct zonelist *node_zonelist(int nid, gfp_t flags)
{
	return NODE_DATA(nid)->node_zonelists + gfp_zonelist(flags);
}

#ifndef HAVE_ARCH_FREE_PAGE
static __inline__ void arch_free_page(struct page *page, int order) { }
#endif
#ifndef HAVE_ARCH_ALLOC_PAGE
static __inline__ void arch_alloc_page(struct page *page, int order) { }
#endif
...
static __inline__ struct page *alloc_pages_node(int nid, gfp_t gfp_mask,
						unsigned int order)
{
...
static __inline__ struct page *alloc_pages_exact_node(int nid, gfp_t gfp_mask,
						unsigned int order)
{
